...
->group(function ()
{
    ...
    Route::post('/clearance/submit', [StudentController::class, 'submitClearance'])
    ...
    Route::get('/report/download', [StudentController::class, 'downloadReport'])
...
->group(function () {
    ...
    Route::get('/clearance/{clearance}', [DepartmentController::class, 'show'])
    ->name('clearance.show');

    Route::post('/clearance/{clearance}/approve', [DepartmentController::class, 'approve'])
    ->name('clearance.approve');
    Route::post('/clearance/{clearance}/reject', [DepartmentController::class, 'reject'])
...
->group(function () {
    ...
    Route::get('/clearances', [AdminController::class, 'clearanceRequests'])
    ->name('clearances');
});
